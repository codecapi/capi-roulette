/**
 * Audio File Mapping Contract
 *
 * Defines the mapping between roulette numbers and their corresponding audio files.
 * This is the authoritative source for audio file paths.
 */
...
// ============================================================================
// Voice Audio Files - Special Announcements
// ============================================================================
...
// ============================================================================
// Voice Audio Files - Result Announcements
// ============================================================================
 ...
 * @returns The filename for the result announcement
 ...
 *
 * @param index - Ball audio index (0-6)
 * @param basePath - Base path for audio files (default: '/audio')
 * @returns Full path to the ball audio file
 */
 ...
 *
 * @param filename - Voice audio filename
 * @param basePath - Base path for audio files (default: '/audio')
 * @returns Full path to the voice audio file
 */
